...
const Websettings: React.FC = () => {
  ...
  const sectionTitle = router.query.section_title || "EmployerSection3";
   ...
   useEffect(() => {
          ...
          if (record) {
            formProps.form?.setFieldsValue({
              ...
              list_details: record.list_details
                ? JSON.parse(record.list_details)
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      >
        <img
          src="./images/employer/section3.png"
          alt="Image 2"
